...
class ErrorOverlay {
    ...
    `;
        ...
        // Add style to head when it's available
        if (document.head) {
        ...
        // Add container to body when it's available
        if (document.body) {
    ...
    render() {
      ...
      <div class="console-whisperer-content">
        <div class="console-whisperer-section">
          ...
          <div class="console-whisperer-error">${escapeHtml(
              errorData.message
          )}</div>
        </div>
        <div class="console-whisperer-section">
          <div class="console-whisperer-section-title">💡 Explanation</div>
          <div class="console-whisperer-explanation">${escapeHtml(
              explanation
          )}</div>
        </div>
        ${
      ...
      <div class="console-whisperer-footer">
        ${
            fix
                ? `<button class="console-whisperer-button" id="console-whisperer-copy">Copy Fix</button>`
                : ""
        }
    ...
    `;
        ...
        // Add event listeners
        document
            .getElementById("console-whisperer-close")
            .addEventListener("click", () => this.hide());

        if (fix) {
            document
                .getElementById("console-whisperer-copy")
